...
#### POST `/api/apps/{id}/invitations/verify`
Mark an invitation as completed (user signed up).
...
2. Verify invitations via `POST /api/apps/{id}/invitations/verify` with mobile auth
